...
const addStylesBasedOnTheTag = (element) => {
    ...
    const styleResult = simpleTags[tag];
    if (styleResult) {
        styleResult();
    }
    else {
...
const checkStyleForNestedElements = (element) => {
...
const addClasses = ({ container, skeletonFirstColor, skeletonSecondColor, }) => {
    if (!container)
        return;
...
const Skeleton = (WrappedComponent) => {
    return function Hoc(props) {
        ...
        return isLoading ? (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsx("div", { "data-testid": "skeleton", ref: containerRef, children: jsxRuntimeExports.jsx(WrappedComponent, { ...defaultProps }) }) })) : (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsx(WrappedComponent, { ...props }) }));
    };
};
